...
class PostController extends Controller
{
    ...
    {
        $blockedIds = $request->user()->getBlockedFriendships()->pluck('id')->toArray();
        $posts = Post::whereNotIn('user_id', $blockedIds)->with('comments.replies')->orderBy('created_at', 'desc')->paginate(10);
