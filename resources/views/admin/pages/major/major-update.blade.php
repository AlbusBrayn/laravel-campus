...
@section('content')
    <main class="workspace">
        ...
        @if($errors->any())
            ...
            @endforeach
        @endif
        <form id="majorForm" action="{{ route('admin.majors.updateStore', ['major' => $major]) }}" method="POST">
            @csrf
            @method('PUT')
                        ...
                        <div class="flex flex-col gap-y-5">
                            <div class="flex items-center">
                                ...
                                <div class="w-1/4 ml-2">
                                    <label class="switch">
                                        <input type="checkbox" name="is_active" @if($major->is_active) checked @endif>
                                        <span></span>
                                    </label>
                                </div>
                            </div>
